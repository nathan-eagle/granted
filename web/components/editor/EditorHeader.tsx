...
export default function EditorHeader({ projectId }: { projectId: string }) {
  ...
  return (
    <div className="pointer-events-none sticky top-0 z-10 flex w-full justify-end px-4 pt-2 pb-1">
      <div className="pointer-events-auto flex items-center gap-2 rounded-md border border-gray-200 bg-white px-3 py-2 shadow-sm">
        <button
          onClick={run}
