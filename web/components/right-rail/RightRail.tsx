  ...
  return (
    <Tabs.Root defaultValue="assistant" className="flex flex-col h-full">
      <Tabs.List className="grid grid-cols-3 gap-2 mb-3">
        <Tabs.Trigger value="assistant" className="rounded-md border px-3 py-2 text-sm data-[state=active]:bg-gray-100">Assistant</Tabs.Trigger>
        <Tabs.Trigger value="citations" className="rounded-md border px-3 py-2 text-sm data-[state=active]:bg-gray-100">Citations</Tabs.Trigger>
        <Tabs.Trigger value="sources" className="rounded-md border px-3 py-2 text-sm data-[state=active]:bg-gray-100">Sources</Tabs.Trigger>
      </Tabs.List>

      <Tabs.Content value="assistant" className="flex-1 overflow-auto">
      ...
      <Tabs.Content value="citations" className="flex-1 overflow-auto">
      ...
      <Tabs.Content value="sources" className="flex-1 overflow-auto">
        <div className="rounded-md border p-3 text-sm">
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-1">
            <li>company.txt (uploaded 2d ago)</li>
            <li>granted_overview.pdf</li>
          </ul>
        </div>
      </Tabs.Content>
    </Tabs.Root>
